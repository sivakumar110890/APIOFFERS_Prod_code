...
public class RAGOptInTest {

	public final static Logger LOGGER = Logger.getLogger(RAGOptInTest.class);
	...
	public void doGet() {
		...
		try {
			...
			when(ragOfferService.getRagOptIn(any(JSONObject.class))).thenReturn(synchOffersObj);
			ragOptIn.doGet(request, response);
		} catch (Exception e) {
			LOGGER.error(e);
		}
	}
